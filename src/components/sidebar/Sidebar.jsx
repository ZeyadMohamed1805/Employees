...
const Sidebar = () => {
    return (
      <Flex className="bg-gradient-to-b from-dashboardGradientTop to-dashboardGradientBottom flex-col items-center min-h-[100vh]" width="106px" pt="50px">
        <Flex className="w-full flex-col justify-center items-center" height="98px" gap="12.9px">
        ...
        <Flex className="w-full flex-col justify-center items-center bg-dashboardEmployees relative before:w-1.5 before:bg-dashboardPseudo before:h-full before:absolute before:left-0" height="98px" gap="12.9px">
