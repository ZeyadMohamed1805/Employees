...
const Header = () => {
    return (
        <Flex height="116px" className="w-full items-center justify-end">
            <Text fontSize="15px" fontWeight="normal" color="#474747" className="max-lg:hidden">Thursday, 03 Oct 02:08:07 PM</Text>
            <Button className="text-white cursor-pointer max-lg:hidden" backgroundColor="#59c203" ml="49px" mr="24.5px" height="27px" width="94px" fontSize="13px" borderRadius="5px">Sign In</Button>
            <Box height="45px" padding="12.5px" mr="12.5px" className="relative border-r-[1px] border-l-[1px] grid place-items-center max-lg:hidden">
